-- JailTrak Invite Code System Database Schema
...
('BETA-2025-LAUNCH', 'Initial beta launch code - unlimited uses', 'System', -1, 1),
('TEAM-MEMBER-001', 'Team member access code - 10 uses', 'System', 10, 1),
('DEMO-ACCESS-123', 'Demo account access - 100 uses', 'System', 100, 1);