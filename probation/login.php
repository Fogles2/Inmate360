<?php
/**
 * JailTrak Probation Officer Login
 */
...
<head>
    ...
    <title>Login - Probation Officer</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="login-container">
        ...
        <h1>Officer Login</h1>
        <p class="subtitle">Probation Alert System</p>
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <input type="email" name="email" required placeholder="officer@example.com" autofocus>
            </div>
