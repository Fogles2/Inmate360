<?php
/**
 * JailTrak Beta Access Page
 * Invite code entry and verification
 */
...
<head>
    ...
    <title>Beta Access - JailTrak</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="beta-container">
        ...
        <h1>🏛️ JailTrak</h1>
        <p class="subtitle">Clayton County Jail Dashboard</p>
        
        <div class="info-box">
            <h3>Welcome to the Beta Program</h3>
            <p>Inmate360 is currently in closed beta testing. You need a valid invite code to access the dashboard.</p>
            ...
            <div class="features-grid">
                ...
                <div class="feature-item">
                    <div class="icon">🎰</div>
                    <div class="title">Random Bond</div>
        ...
        <div class="request-access">
            ...
            <a href="mailto:admin@inmate360.com?subject=Beta Access Request">Request Beta Access</a>
        </div>
    </div>
</body>
</html>